...
description: Sync local .tokens.json with admin's GTO Wizard token from Supabase DB. Use when regression tests fail with "token 過期" or after admin updates their token via /settoken.
user_invocable: true
---
